...
from app.modules.workflow_results import workflow_results_bp
...
def health_check():
    ...
    return jsonify({"status": "running", "database": db_status}), 200
...
def create_app():
    ...
    app.register_blueprint(workflow_results_bp, url_prefix="/api/workflow-results")
